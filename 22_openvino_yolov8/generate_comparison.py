#!/usr/bin/env python3
"""Compare OpenVINO CPU evidence with lesson 15 TensorRT GPU evidence."""
...
def main() -> int:
    ...
    parser.add_argument("--openvino", type=Path,
                        default=ROOT / "22_openvino_yolov8/outputs/openvino_benchmark.json")
    parser.add_argument("--tensorrt", type=Path,
                        default=ROOT / "15_precision_performance_report/outputs/performance.json")
    parser.add_argument("--output", type=Path,
                        default=ROOT / "22_openvino_yolov8/outputs/comparison.md")
