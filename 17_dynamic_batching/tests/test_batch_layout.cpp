...
int main() {
    try {
        require(lesson17::input_batch_offset(2, 3, 4, 5) == 120, "input offset mismatch");
        require(lesson17::output_batch_offset(3, {4, 84, 8400}) == 2116800,
                "output offset mismatch");
        const auto input = lesson17::make_batched_input(4, 3, 2, 2);
        ...
        bool threw = false;
        try { (void)lesson17::checked_volume({1, -1, 4}); } catch (...) { threw = true; }
