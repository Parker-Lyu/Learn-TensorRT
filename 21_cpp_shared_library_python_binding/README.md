...
- Generate lesson 05's dynamic ONNX model and build lesson 14's dynamic TensorRT engine.
...
cmake --build 21_cpp_shared_library_python_binding/build --parallel
```
...
1. Expose the lesson 14 TensorRT runner through a narrow, stable C ABI.
