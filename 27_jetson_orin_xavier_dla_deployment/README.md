# 27 - Jetson Orin/Xavier and DLA Deployment
...
```bash
python3 27_jetson_orin_xavier_dla_deployment/check_platform.py
```
...
```bash
./27_jetson_orin_xavier_dla_deployment/build_target_engines.sh
```
...
```bash
python3 27_jetson_orin_xavier_dla_deployment/analyze_fallback.py
python3 27_jetson_orin_xavier_dla_deployment/benchmark_target.py
```
...
```bash
python3 -m unittest discover -s 27_jetson_orin_xavier_dla_deployment/tests -v
python3 27_jetson_orin_xavier_dla_deployment/check_platform.py
```
