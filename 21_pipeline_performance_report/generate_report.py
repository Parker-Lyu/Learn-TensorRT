#!/usr/bin/env python3
"""Render checkpoint 21 from collected evidence and lesson 20 CSV."""
...
def render(evidence: dict, cuda_rows: list[dict]) -> str:
    ...
    return f"""# 21 - Pipeline Performance and Reliability Report
...
```bash
python3 21_pipeline_performance_report/collect_pipeline_evidence.py --soak-minutes 30 --restart-cycles 100
python3 21_pipeline_performance_report/generate_report.py
```
...
def main() -> int:
    ...
    parser.add_argument("--evidence", type=Path,
                        default=ROOT / "21_pipeline_performance_report/outputs/evidence.json")
    parser.add_argument("--output", type=Path,
                        default=ROOT / "reports/21_pipeline_performance.md")
