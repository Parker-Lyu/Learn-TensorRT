...
DEFAULT_ENGINES = {
    "fp32": ROOT / "14_yolov8_int8_quantization_engineering/outputs/tensorrt10/references/yolov8n_trt10_fp32.engine",
    "fp16": ROOT / "14_yolov8_int8_quantization_engineering/outputs/tensorrt10/references/yolov8n_trt10_fp16.engine",
    "int8": ROOT / "14_yolov8_int8_quantization_engineering/outputs/tensorrt10/candidate/yolov8n_qdq_int8.engine",
}
...
def require_course_tensorrt(version: str) -> None:
    if not version.startswith(EXPECTED_TRT_SERIES + "."):
        raise RuntimeError(
            f"checkpoint 15 requires TensorRT {EXPECTED_TRT_SERIES}.x, found {version}"
        )
