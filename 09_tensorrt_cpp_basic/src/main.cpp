...
lesson09::InputShape parse_input_shape(std::string_view text) {
...
int main(int argc, char* argv[]) {
    try {
        ...
        const lesson09::AppReport report = lesson09::run_tensorrt_cpp_basic(config);
        ...
        for (const lesson09::TensorSummary& tensor : report.tensors) {
