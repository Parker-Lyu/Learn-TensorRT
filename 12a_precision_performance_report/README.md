...
- Complete lesson 12's reproduction procedure and retain its matched engine, dataset, quality, and inspector evidence.
...
The generator writes an evidence-backed local report to `reports/12a_precision_performance.md`. It
...
- The generated `reports/12a_precision_performance.md` is ignored and environment-specific.
