...
LESSON_DIR = REPO_ROOT / "07_polygraphy_precision_alignment"
...
def write_precision_note(report: dict[str, Any], path: Path) -> None:
    ...
    lines = [
        ...
        "",
        f"- {report['scope_note']}",
        "- Use lesson 14 to compare FP32, FP16, and INT8 detections across a representative image set.",
        "",
        "## Result",
        "",
    ]
