# 28 - C++ Shared Library and Python Binding
...
```bash
cmake -S 28_cpp_shared_library_python_binding -B 28_cpp_shared_library_python_binding/build
cmake --build 28_cpp_shared_library_python_binding/build --parallel
```
...
python3 28_cpp_shared_library_python_binding/python/trt_ctypes.py --batch 2
```
...
```bash
python3 -m unittest discover -s 28_cpp_shared_library_python_binding/tests -v
```
