...
void test_letterbox_wide_image() {
    ...
    lesson10::LetterboxInfo info;
    const cv::Mat letterboxed = lesson10::letterbox_image(image, cv::Size(640, 640), info);
...
void test_invalid_preprocess_inputs() {
    ...
    try {
        lesson10::LetterboxInfo info;
        (void)lesson10::letterbox_image(cv::Mat{}, cv::Size(640, 640), info);
...
void test_map_box_clamps_padding() {
    ...
    const lesson10::Box mapped =
        lesson10::map_box_to_original(lesson10::Box{0.0F, -5.0F, 700.0F, 700.0F}, info);
