...
| Precision alignment and backend output debugging | Covered as core deployment-debug path | `05_torch_to_onnx`, `06a_polygraphy_precision_alignment`, `12_yolov8_int8_calibration`, `24_benchmark_report` |
