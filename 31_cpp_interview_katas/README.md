# 31 - C++ Deployment Interview Katas
...
```bash
cmake -S 31_cpp_interview_katas -B 31_cpp_interview_katas/build
cmake --build 31_cpp_interview_katas/build --parallel
```
...
```bash
./31_cpp_interview_katas/build/katas_demo
```
