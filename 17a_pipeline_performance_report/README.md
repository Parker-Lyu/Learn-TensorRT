...
- Build lessons 13, 15, 16, and 17 first.
...
- The generated `reports/17a_pipeline_performance.md` is ignored and must state incomplete formal gates explicitly.
...
1. Generate reproducible load, latency, throughput, fairness, memory, and stability evidence for lessons 13 through 17.
