...
LESSON14 = Path(__file__).resolve().parents[1]
LESSON10 = REPO_ROOT / "10_yolov8_trt_python"
sys.path.insert(0, str(LESSON14))
sys.path.insert(0, str(LESSON10))
...
DEFAULT_OUTPUT = LESSON14 / "outputs/00_qualification/preprocessing_parity.json"
