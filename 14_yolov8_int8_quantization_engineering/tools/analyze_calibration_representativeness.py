#!/usr/bin/env python3
"""Compare lesson 14 calibration-image geometry with the full COCO train2017 split."""
...
def plot_distributions(
    ...
    figure.suptitle("Lesson 14 calibration geometry vs. full COCO train2017", fontsize=16)
