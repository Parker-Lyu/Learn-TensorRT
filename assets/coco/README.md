...
This directory prepares the shared COCO annotations and complete labeled val2017 split. Lesson 14
...
After preparing these shared prerequisites, run lesson 14's selector. It samples the calibration
...
```bash
python3 14_yolov8_int8_quantization_engineering/tools/prepare_calibration_dataset.py \
  --materialize
```
