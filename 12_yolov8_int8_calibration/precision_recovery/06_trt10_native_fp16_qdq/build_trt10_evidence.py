...
EXPECTED_HASHES = {
    FP32_ONNX: "738879ea1d605f6bdce1454120cf02b89cc5fdbbc233dcf2d5a4120762b96260",
    QDQ_ONNX: "3fad6a3dba71e4026c7e8036a413fbc027dd310cf15c91e72ccdda70e677dc90",
}
EXPECTED_IO = [
...
def main() -> int:
    ...
    for path, expected in EXPECTED_HASHES.items():
        validate_identity(path, expected)
