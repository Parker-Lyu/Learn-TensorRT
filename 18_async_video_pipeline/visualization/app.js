...
const base = {
  ...
  gpu: [{name:'CPU / 准备（串行生产）',jobs:[['F0 准备',0,2,'prep'],['F1 准备',2,4,'prep'],['F2 准备',4,6,'prep'],['F3 准备',6,8,'prep']]} , {name:'GPU / Stream 0',jobs:[['F0 H2D',2,3,'h2d'],['F0 计算',3,5,'compute'],['F2 H2D',6,7,'h2d'],['F2 计算',7,9,'compute']]}, {name:'GPU / Stream 1',jobs:[['F1 H2D',4,5,'h2d'],['F1 计算',5,7,'compute'],['F3 H2D',8,9,'h2d'],['F3 计算',9,10,'compute']]}],
